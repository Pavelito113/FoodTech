    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EndProduct", x => x.EndProductId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentCategory", x => x.EquipmentCategoryId);
                    table.ForeignKey(
                        name: "FK_EquipmentCategory_EquipmentCategory_ParentCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipment_Industry_IndustryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactRequest_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentEndProduct", x => new { x.EquipmentId, x.EndProductId });
                    table.ForeignKey(
                        name: "FK_EquipmentEndProduct_EndProduct_EndProductId",
                        column: x => x.EndProductId,
                        principalTable: "EndProduct",
                        principalColumn: "EndProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentEndProduct_Equipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipment",
                        principalColumn: "EquipmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EquipmentImage_Equipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipment",
                        principalColumn: "EquipmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EquipmentSpecId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EquipmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentSpec", x => x.EquipmentSpecId);
                    table.ForeignKey(
                        name: "FK_EquipmentSpec_Equipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipment",
                        principalColumn: "EquipmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequest_EquipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentCategory_ParentCategoryId",
                table: "EquipmentCategory",
                column: "ParentCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_EquipmentEndProduct_EndProductId",
                table: "EquipmentEndProduct",
                column: "EndProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentSpec_EquipmentId",
                table: "EquipmentSpec",
                column: "EquipmentId");
        }
